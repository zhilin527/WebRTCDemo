...
window.onload = function () {
    ...
    joinButton.disabled = !(navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia);
    ...
    if (hash) {
        ...
        document.getElementById("session_txt").value = Math.random().toString(16).substr(10);
    }
};
